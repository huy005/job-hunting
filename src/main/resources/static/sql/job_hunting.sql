...
INSERT INTO job_description_db(job_description_address,quantity,experience,job_description_rank,salary,title,job_description_type,description,status,deadline,view,company_id,category_id)
VALUES ('001 HHP',2,'3y','high',15000,'Looking for A','Full Time','Good Job No.1',1,'2023-09-30',10,1,1),
('112 MMW',1,'5y','low',25000,'Looking for A,B','Full Time','High-Quality Job',1,'2024-02-01',8,1,1),
('223 IIO',5,'1y','high',10000,'Looking for A','Part Time','Easy Job',1,'2023-08-17',10,2,1),
('334 AAK',2,'1y','medium',12000,'Looking for C','Full Time','Friendly Envi',1,'2023-10-13',3,3,2),
('445 IWN',4,'3y','low',18000,'Looking for C,D','Full Time','Easy-going Colleague',1,'2024-01-25',6,1,2),
('556 UUE',7,'4y','medium',20000,'Looking for A,C','Part Time','Competative Salary',1,'2023-12-23',16,4,3),
('667 JJQ',5,'3y','high',16500,'Looking for B','Full Time','Decent Benefit',1,'2023-11-30',5,3,4);
...
VALUES ('Cv Xuan',1),('Cv Tuan',2),('Cv Dung',3),('Cv Sinh',4),('Cv Anh',5),('Cv Huong',6),('Cv Nam',7),('Cv Xuan2',8);
